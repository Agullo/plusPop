...
public class Facade {
	...
	public String cadastraUsuario(String nome, String email, String senha, String dataNasc) throws CadastroDeUsuarioException {
	...
	public void fechaSistema() throws FechaSistemaException {
		...
		try {
			BufferedOutputStream arquivoDeGravacao = new BufferedOutputStream(new FileOutputStream(CAMINHO_BACKUP));
			...
			objetoDeGravacao.close();
			arquivoDeGravacao.flush();
			arquivoDeGravacao.close();
		} catch (Exception e) {
			e.printStackTrace();
		}
//		controller == null;
